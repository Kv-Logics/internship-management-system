...
import { 
  ...
  Database, Play, AlertCircle, CheckCircle2, Server
} from 'lucide-react';
...
export default function FacultyDatabase() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Admin Tab Selector */}
      {user?.role === 'admin' && (
        <div className="flex bg-gray-100 p-1.5 rounded-2xl w-max border border-gray-200 shadow-inner">
          <button
      ...
      {activeTab === 'directory' ? (
        ...
        /* SQL Query Terminal Tab View */
        <div className="bg-slate-900 rounded-3xl border border-slate-800 shadow-2xl overflow-hidden text-slate-100 p-6 space-y-6 animate-fadeIn">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full h-36 bg-slate-950 border border-slate-800 rounded-2xl p-4 font-mono text-sm text-emerald-400 focus:outline-none focus:ring-2 focus:ring-indigo-600 placeholder-slate-600 leading-relaxed shadow-inner"
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-6 py-3 bg-indigo-650 hover:bg-indigo-750 active:bg-indigo-850 disabled:bg-slate-800 text-white rounded-xl text-xs font-bold transition-all shadow-lg shadow-indigo-600/10 cursor-pointer"
            >
              {executingQuery ? (
                <>
