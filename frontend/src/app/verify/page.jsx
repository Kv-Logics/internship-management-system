      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        <div className="space-y-8 lg:sticky lg:top-12">
          ...
          <div className="text-center lg:text-left space-y-4">
            <div className="mx-auto lg:mx-0 w-24 h-24 flex items-center justify-center mb-6">
              <img 
                src="/nitt_logo.png" 
                alt="NIT Trichy Logo" 
            ...
            <p className="text-sm text-slate-500 max-w-xl mx-auto lg:mx-0">
        ...
        <div className="w-full h-full flex flex-col justify-center min-h-[400px]">
          {!result && !error && !loading && (
            <div className="h-full border-2 border-dashed border-slate-200 rounded-3xl flex flex-col items-center justify-center p-12 text-center text-slate-400 bg-slate-50/50">
              <ShieldCheck size={48} className="mb-4 text-slate-300" />
              <p className="font-medium">Enter a Verification ID to view certificate details.</p>
            </div>
          )}

          {/* Error Message */}
          {error && (
            <div className="w-full bg-rose-50 border border-rose-200 p-6 rounded-2xl flex items-start space-x-4 animate-fadeIn shadow-lg shadow-rose-900/5">
          ...
          {/* Success Result */}
          {result && (
            <div className="w-full bg-white border border-emerald-100 shadow-2xl shadow-emerald-500/10 rounded-3xl overflow-hidden animate-fadeIn">
