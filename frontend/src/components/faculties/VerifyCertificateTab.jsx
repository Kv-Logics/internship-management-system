      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200">
            <form onSubmit={handleVerify} className="relative flex items-center">
              ...
              <input
                type="text"
                className="block w-full pl-10 pr-32 py-3.5 border border-slate-200 rounded-xl leading-5 bg-white placeholder-slate-405 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-xs font-semibold transition-all"
              ...
              <button
                ...
                className="absolute right-2 top-2 bottom-2 px-5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-lg transition-all disabled:opacity-50 flex items-center cursor-pointer"
              >
                {loading ? (
        ...
        <div className="w-full h-full flex flex-col justify-center min-h-[220px]">
          {!result && !error && !loading && (
            <div className="h-full border-2 border-dashed border-slate-200 rounded-2xl flex flex-col items-center justify-center p-8 text-center text-slate-400 bg-slate-50/50">
          ...
          {/* Error Message */}
          {error && (
            <div className="w-full bg-rose-50 border border-rose-200 p-5 rounded-2xl flex items-start space-x-3 animate-fadeIn shadow-sm">
          ...
          {/* Success Result */}
          {result && (
            <div className="w-full bg-white border border-emerald-150 shadow-lg rounded-2xl overflow-hidden animate-fadeIn">
              <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 p-5 text-white flex items-center justify-between">
                ...
                <div className="bg-white/20 px-2.5 py-0.5 rounded-lg border border-white/20 text-[10px] font-bold tracking-wider">
                  VERIFIED
                </div>
              </div>
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="bg-slate-100 p-2 rounded-xl text-slate-500"><User size={16} /></div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-slate-100 pt-4">
                  <div className="flex items-start space-x-3">
                    <div className="bg-slate-100 p-2 rounded-xl text-slate-500"><BookOpen size={16} /></div>
                    <div>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="bg-slate-100 p-2 rounded-xl text-slate-500"><Calendar size={16} /></div>
                    <div>
                ...
                <div className="border-t border-slate-100 pt-4 flex items-start space-x-3">
                  <div className="bg-slate-100 p-2 rounded-xl text-slate-500"><Award size={16} /></div>
                  <div>
